            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                <div key={exp.title} className="relative flex items-start">
                  ...
                  {/* Content */}
                  <div className="ml-20 bg-white p-6 rounded-xl shadow-sm border border-gray-100 w-full group hover:shadow-md transition-all duration-300">
                    <div className="flex items-center mb-3">
                      <span className="text-2xl mr-3">{exp.icon}</span>
                      <div className="flex-1">
                        <h3 className="font-heading font-bold text-gray-900 text-xl">{exp.title}</h3>
